...
export default function TerminatedView() {
  ...
  const getAdjustedThreat = (id: string, base: number, profile: string): number => {
    ...
    if (profile === 'Totem of Undying') {
      ...
      return Math.max(0.1, +(base * 0.65).toFixed(1));
    }
    if (profile === 'Infinity Totem') {
      const voidOrExtremeEntities = ['void_blossom', 'the_chaos', 'zoranth', 'fourth_calamity', 'zoranth_newborn_of_the_zenith', 'spore_verfalldrache', 'tormentor'];
  ...
  const initialOpponents: Opponent[] = [
    ...
    },
    {
      ...
      category: 'Modded',
      modName: 'ArPhEx',
      image: 'terminated_entities/Modded/ArPhEx/tormentor.png',
      threatLevel: 10.0,
  ...
  useEffect(() => {
    ...
    rotImg.src = getAbsoluteAssetUrl('terminated_entities/Rot.png');
  },
 []);
              ...
              <div className="relative grid grid-cols-2 gap-0 flex-1 items-stretch justify-stretch bg-[#8fa5a0] z-10 overflow-hidden">
                    ...
                    <img
                      ...
                      onError={(e) => {
                        ...
                        if (!img.dataset.triedFallback) {
                          ...
                          if (img.src.includes('/terminated_entities/')) {
                            img.src = img.src.replace('/terminated_entities/', '/terminated_entities/');
                          }
                        }
                      }}
                    />
                ...
                <div className="relative flex flex-col items-center justify-center h-full w-full overflow-hidden bg-neutral-900/5">
                  <div className="w-full h-full flex items-center justify-center relative">
                    <img
                      src={getAbsoluteAssetUrl('terminated_entities/Rot.png')}
                      alt="The Rot"
                      referrerPolicy="no-referrer"
                      className="max-h-[88%] max-w-[88%] object-contain select-none filter grayscale contrast-[1.45] brightness-[0.88] mix-blend-multiply"
                      onError={(e) => {
            ...
            <div className="space-y-4 text-sm text-[#b0bec5]">
              ...
              <div className="grid grid-cols-1 gap-2 mt-4 bg-[#13161f] p-4 rounded-xl border border-[#1f2330]">
                <div className="flex gap-4 p-2 hover:bg-[#1a1e29] rounded transition-colors">
                  ...
                  <span>Easily terminated life, passive creatures, and low-tier vanilla combatants (rendered almost entirely harmless by the Rot's upgraded AI).</span>
                </div>
                <div className="flex gap-4 p-2 hover:bg-[#1a1e29] rounded transition-colors">
                  <span className="w-16 font-bold text-green-400">2.1–4.0</span>
                  <span>Common hostile mobs and standard vanilla entities, requiring minimal adaptive effort to neutralise.</span>
                </div>
                <div className="flex gap-4 p-2 hover:bg-[#1a1e29] rounded transition-colors">
