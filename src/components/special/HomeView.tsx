        ...
        <div className="p-5 bg-gradient-to-r from-[#17140b] via-[#0f110d] to-[#0c0e0c] border border-amber-500/40 rounded-xl space-y-3 shadow-lg">
          ...
          <div className="text-xs text-[#9eb0a1] space-y-1.5 font-mono pt-1">
            ...
            <ul className="list-disc list-inside space-y-1.5 text-[#829285] pl-1">
              <li><strong className="text-amber-300">Vanilla & Modded Threat Downgrades:</strong> Calibrated and lowered threat levels for all remaining vanilla hostiles (Warden to 8.7, Blaze to 4.0, Ghast to 2.3, Husk to 2.0, Iron Golem to 3.0) by -0.5, and applied a consistent -0.4 downgrade across all modded entities in the Terminated Dossier to reflect the Rot's absolute combat supremacy. Kept the 10.0 scale ceiling (Tormentor) and newly established Integrity (1.5) ratings untouched.</li>
              <li><strong className="text-amber-300">Terminated Dossier: Integrity Phase 3 Update:</strong> Documented Integrity (Phase 3) from *The Broken Script* under CYCLE 89. Factored in the Rot's upgraded direct-memory health bypass AI that completely ignores boss damage filters, and calibrated its ultimate termination difficulty rating at a vulnerable 1.5. Adjusted threat ratings for vanilla threats (Ender Dragon, Elder Guardian, Creeper).</li>
