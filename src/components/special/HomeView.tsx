        ...
        <div className="p-5 bg-gradient-to-r from-[#17140b] via-[#0f110d] to-[#0c0e0c] border border-amber-500/40 rounded-xl space-y-3 shadow-lg">
          ...
          <div className="text-xs text-[#9eb0a1] space-y-1.5 font-mono pt-1">
            ...
            <ul className="list-disc list-inside space-y-1.5 text-[#829285] pl-1">
              ...
              <li><strong className="text-amber-300">Mental Degradation Corrections:</strong> Verified and aligned cognitive breakdown thresholds with the raw tick logic. Purged the undocumented "Severe Visual Vignette" entries to match the strict procedure implementations.</li>
              <li><strong className="text-amber-300">Woodweaver Viewport Unveil:</strong> Removed the staged placeholder indicators and the rotated censor overlay banner, enabling full interactive 3D model viewing of the boss entity.</li>
              <li><strong className="text-amber-300">New Content &amp; Entity Expansion:</strong> Added the Hewn Splinter entity (paralyzed block-form cubic entity spawning exclusively in Wood Plains &amp; Thicket biomes with 3D model staging and lore), Petrified Rotten Dagger (6.5 damage, 2.0 speed, 20% on-hit debuffs, and -10% entity reach penalty), Petrified Oak Gall (throwable projectile dropped from Amber Grit), Tetherless Pearl 40-tick throw cooldown, Windcap Mushroom (with integrated Light Lungs status effect stats: +8% movement efficiency &amp; -1 exhaustion every 2s), and Ash Berries.</li>
              <li><strong className="text-amber-300">Advancements &amp; XP Rewards Calibration:</strong> Removed the legacy &quot;Coward&apos;s Smoke&quot; advancement entry and updated the &quot;Sentinel&quot; trial challenge reward to grant 2,077 XP upon facing the Rot boss.</li>
              <li><strong className="text-amber-300">Entity Spawning &amp; Rarity Calibration:</strong> Updated the Woodweaver's native home realm to <em>The Grain</em> with its 20% spawn roll and 256-block exclusion radius; documented exact natural spawning procedures for the Ash-Weaver (87.5-block clearance on occluding substrate), Kyne Splinter (15% roll, 512-block isolation), Dorceless Splinter (25% roll, 128-block radius), Hollow, and subterranean/petrified Lignum organisms.</li>
              ...
              <li><strong className="text-amber-300">Terminated Dossier Threat Rating Calibration:</strong> Recalibrated threat ratings for the updated Rot.</li>
              <li><strong className="text-amber-300">Rot Sentinel Neural &amp; Combat Overhaul</strong>.</li>
