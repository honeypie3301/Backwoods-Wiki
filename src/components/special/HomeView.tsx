        ...
        <div className="p-5 bg-gradient-to-r from-[#17140b] via-[#0f110d] to-[#0c0e0c] border border-amber-500/40 rounded-xl space-y-3 shadow-lg">
          ...
          <div className="text-xs text-[#9eb0a1] space-y-1.5 font-mono pt-1">
            ...
            <ul className="list-disc list-inside space-y-1.5 text-[#829285] pl-1">
              ...
              <li><strong className="text-amber-300">Terminated Dossier Calibration:</strong> Re-anchored the Kronos termination registry to always initialize from the lowest threat specimen (Husk 0.6 / Integrity 1.5), re-scaled all modded threat levels downwards (-0.4 to -1.0), and heavily reduced vanilla hostile threat ratings (Warden 6.8, Blaze 2.0, Elder Guardian 1.8, Creeper 1.2, Ghast 0.9, Husk 0.6) while maintaining Integrity (1.5) and Tormentor (10.0) benchmarks.</li>
