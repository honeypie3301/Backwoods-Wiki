        ...
        <div className="p-5 bg-gradient-to-r from-[#17140b] via-[#0f110d] to-[#0c0e0c] border border-amber-500/40 rounded-xl space-y-3 shadow-lg">
          ...
          <div className="text-xs text-[#9eb0a1] space-y-1.5 font-mono pt-1">
            ...
            <ul className="list-disc list-inside space-y-1 text-[#829285] pl-1">
              <li><strong className="text-amber-300">The Woodweaver Boss:</strong> Integrated the highly dangerous Extermination Class boss entity. Stalks players from up to 96 blocks away with locked-gaze backtracking, accumulating Dread until it awakens to unleash adaptive hypnosis (Infect, Leech, and Incinerate) and a colossal block-vaporizing beam. Emits custom scream beacons and triggers a 10-second levitating Core Detonation explosion on defeat. Wrapped with full 3D interactive model staging and expandable ability dossier cards.</li>
