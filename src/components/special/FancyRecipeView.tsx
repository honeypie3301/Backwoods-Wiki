          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="w-full py-4 px-3 bg-[#080a08]/40 rounded-lg border border-[#111712] flex justify-center items-center relative z-10">
                  {isSmelting ? (
                    <div className="flex items-center gap-3 sm:gap-4 flex-nowrap shrink-0">
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="relative group shrink-0 hover:z-30">
                            <div className={`w-11 h-11 sm:w-14 sm:h-14 border rounded-lg flex flex-col items-center justify-center p-1 sm:p-1.5 shadow-inner transition-all duration-200 cursor-help ${spec.bgClass} ${spec.borderClass} ${spec.textClass} ${spec.glowClass} hover:border-[#709978] shrink-0`}>
                              <span className="text-[10px] sm:text-xs font-mono font-bold">{spec.short}</span>
                            </div>
                            {/* Tooltip */}
                      ...
                      {/* Arrow */}
                      <div className="text-[#3a4f3e] font-bold text-base sm:text-lg select-none shrink-0">➔</div>

                      {/* Furnace Output Slot */}
                      <div className="relative group shrink-0 hover:z-30">
                        <div className={`w-14 h-14 sm:w-16 sm:h-16 border-2 rounded-lg flex flex-col items-center justify-center p-1 sm:p-1.5 shadow-inner transition-all duration-200 ${outputSpec.bgClass} ${outputSpec.borderClass} ${outputSpec.textClass} ${outputSpec.glowClass} shrink-0`}>
                          <span className="text-xs sm:text-sm font-mono font-bold">{outputSpec.short}</span>
                        </div>
                        <span className="absolute bottom-1 right-1 bg-[#121613] border border-[#303d33] px-1 text-[8px] sm:text-[9px] font-mono text-amber-400 font-bold rounded">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 flex-nowrap shrink-0">
                      ...
                      <div className="relative group shrink-0 hover:z-30">
                        ...
                        <span className="absolute bottom-1 right-1 bg-[#121613] border border-[#303d33] px-1 text-[8px] sm:text-[9px] font-mono text-[#a9d1b0] font-bold rounded">
                          x{recipe.outputCount}
                        </span>
                        {/* Tooltip */}
                        <div className="opacity-0 pointer-events-none group-hover:opacity-100 transition-all duration-200 absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-[#080a08] border border-[#223024] text-xs font-mono p-2 rounded shadow-2xl z-25 flex flex-col items-center gap-0.5 min-w-[120px]">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 flex-nowrap shrink-0">
                      ...
                      <div className="relative group shrink-0 hover:z-30">
                        ...
                        <span className="absolute bottom-1 right-1 bg-[#121613] border border-[#303d33] px-1 text-[8px] sm:text-[9px] font-mono text-emerald-400 font-bold rounded">
                          x{recipe.outputCount}
                        </span>
                        {/* Tooltip */}
                        <div className="opacity-0 pointer-events-none group-hover:opacity-100 transition-all duration-200 absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-[#080a08] border border-[#223024] text-xs font-mono p-2 rounded shadow-2xl z-20 flex flex-col items-center gap-0.5 min-w-[120px]">
                    ...
                    <div className="flex items-center gap-3 sm:gap-6 flex-nowrap shrink-0">
                      {/* 3x3 Grid Layout */}
                              ...
                              if (ingredient) {
                                ...
                                cells.push(
                                  <div key={idx} className="relative group shrink-0 hover:z-30">
                                    <div className={`w-9 h-9 sm:w-11 sm:h-11 border rounded-lg flex flex-col items-center justify-center p-0.5 sm:p-1 shadow-inner transition-all duration-200 cursor-help ${spec.bgClass} ${spec.borderClass} ${spec.textClass} ${spec.glowClass} hover:border-[#709978] shrink-0`}>
                                ...
                                cells.push(
                                  <div key={idx} className="w-9 h-9 sm:w-11 sm:h-11 bg-[#040504] border border-[#121612] rounded-lg shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.85)] opacity-25 shrink-0" />
                                );
                              }
                            }
                          } else {
                            ...
                            for (let r = 0; r < 3; r++) {
                              ...
                              for (let c = 0; c < 3; c++) {
                                ...
                                if (char !== ' ') {
                                  ...
                                  cells.push(
                                    <div key={`${r}-${c}`} className="w-9 h-9 sm:w-11 sm:h-11 bg-[#040504] border border-[#121612] rounded-lg shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.85)] opacity-25 shrink-0" />
                                  );
                                }
                              }
                            }
                      ...
                      {/* Arrow */}
                      <div className="text-[#3a4f3e] font-bold text-lg sm:text-xl select-none animate-pulse shrink-0">➔</div>

                      {/* Large Output Slot */}
                      <div className="relative group shrink-0 hover:z-30">
                        <div className={`w-14 h-14 sm:w-16 sm:h-16 border-2 rounded-xl flex flex-col items-center justify-center p-1 shadow-inner transition-all duration-300 ${outputSpec.bgClass} ${outputSpec.borderClass} ${outputSpec.textClass} ${outputSpec.glowClass} shrink-0`}>
                          <span className="text-sm sm:text-base font-mono font-bold tracking-tight">{outputSpec.short}</span>
                        </div>
                        <span className="absolute bottom-1 right-1 bg-[#121613] border border-[#303d33] px-1 py-0.5 text-[8px] sm:text-[9px] font-mono text-[#a9d1b0] font-bold rounded shadow-md z-10 select-none">
                          x{recipe.outputCount}
                        </span>
                        {/* Tooltip */}
                        <div className="opacity-0 pointer-events-none group-hover:opacity-100 transition-all duration-200 absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-[#080a08] border border-[#223024] text-xs font-mono p-2 rounded shadow-2xl z-20 flex flex-col items-center gap-0.5 min-w-[120px]">
