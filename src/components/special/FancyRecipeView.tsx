...
function getItemVisualSpec(rawId: string): VisualSpec {
  ...
  const mapping: Record<string, { short: string; bg: string; text: string; border: string; glow: string }> = {
    ...
    'atrophy_potion': { short: 'Apo', bg: 'bg-[#181216]', text: 'text-[#ec4899]', border: 'border-[#3f1627]', glow: 'group-hover:shadow-[0_0_10px_rgba(236,72,153,0.15)]' },
    'cellular_collapse_potion': { short: 'Cc1', bg: 'bg-[#210f13]', text: 'text-[#f43f5e]', border: 'border-[#5c1122]', glow: 'group-hover:shadow-[0_0_12px_rgba(244,63,94,0.2)]' },
    'cellular_collapse_potion_2': { short: 'Cc2', bg: 'bg-[#290812]', text: 'text-[#fda4af]', border: 'border-[#7c112b]', glow: 'group-hover:shadow-[0_0_14px_rgba(253,164,175,0.25)]' },
    'awkward_potion': { short: 'Awk', bg: 'bg-[#12111c]', text: 'text-[#a855f7]', border: 'border-[#2c1a4d]', glow: '' },
    'phantom_membrane': { short: 'Pm', bg: 'bg-[#151c1c]', text: 'text-[#2dd4bf]', border: 'border-[#1a3835]', glow: '' },
    'dragon_breath': { short: 'Db', bg: 'bg-[#220d1c]', text: 'text-[#f472b6]', border: 'border-[#4c163a]', glow: '' },
    'glowstone_dust': { short: 'Gd', bg: 'bg-[#2e2610]', text: 'text-[#fbbf24]', border: 'border-[#5a4613]', glow: '' },
